...
export const CategoryIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M11 20H4a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h7l2 3h9a2 2 0 0 1 2 2v2.5"></path><path d="m15.5 14-3 3 3 3"></path><path d="m20.5 14-3 3 3 3"></path></svg>
);

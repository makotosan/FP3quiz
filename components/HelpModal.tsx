...
const HelpModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center p-4 z-[100]" onClick={handleClose}>
      <div className="bg-white rounded-lg p-6 max-w-lg w-full max-h-[80vh] overflow-y-auto dark:bg-slate-800" onClick={(e) => e.stopPropagation()}>
        <h2 className="text-2xl font-bold mb-4 text-gray-800 dark:text-gray-100">アプリの使い方</h2>
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <div>
           ...
           <div>
            ...
            <p>文字サイズの変更や、間違えた問題の優先出題など、学習しやすいようにカスタマイズできます。ダークモードの切り替えもここで行えます。</p>
          </div>
          <div>
            <h3 className="font-semibold text-lg mb-1">アプリの更新</h3>
            <p>新しいバージョンが利用可能になると、設定画面に「新しいバージョンに更新」ボタンが表示されます。ボタンを押すと、アプリを最新の状態にアップデートできます。</p>
          </div>
          <div>
